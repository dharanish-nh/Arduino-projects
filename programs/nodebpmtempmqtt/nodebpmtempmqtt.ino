...
Ticker flipper;
WiFiManager wifiM;
WiFiServer server(80); // creating an object and on the port 80 for http page
char* mqtt_server = "10.3.141.1";
char* mqtt_username = "";
char* mqtt_password = "";
const char* clientID = "bca105";
String sndtp = String(clientID) + "_espsend";
String rcvtp = String(clientID) + "_esprecv";
String s = "";
...
void setup()
{
  ...
  //  Serial.println(ssid);
  // wifiM.autoConnect("ESP-HOTSPOT", "12345678");
  ...
  if (client.connect(clientID, mqtt_username, mqtt_password)) {
    Serial.println("Connected to MQTT Broker! subtop:" + rcvtp);
    mqtt.subscribe(rcvtp, topic1_subscriber);
  }
  else
  {
